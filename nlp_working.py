...
print()
print("**************************************************")
print("Predictions for Teacher Reviews: Q51")
print("**************************************************")
print()
...
path = r'Desktop'
df.to_csv(os.path.join(path,r'teacher_review_sentiment_Q51.csv'))


print()
print("**************************************************")
print("Predictions for Teacher Reviews: Q52")
print("**************************************************")
print()

df = pd.read_excel(r'Desktop\1_Teacher_reviews_Q52_test.xlsx')
...
path = r'Desktop'
df.to_csv(os.path.join(path,r'teacher_review_sentiment_Q52.csv'))
